    ...
    <header className="h-14 shrink-0 flex items-center justify-between px-4 border-b border-slate-700/60 bg-slate-900 z-20">
      ...
      <div className="flex items-center gap-1">
        ...
        <div className="relative">
          ...
          {notifOpen && (
            <div className="absolute right-0 top-10 w-72 bg-slate-800 border border-slate-700 rounded-xl shadow-2xl overflow-hidden z-50">
              ...
              <div className="divide-y divide-slate-700/60">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3 px-4 py-3 hover:bg-slate-700/40 transition-colors cursor-pointer">
